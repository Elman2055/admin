...
const AddProductModal = ({
  ...
  const onSubmit = async (e: React.ChangeEvent<HTMLFormElement>) => {
    ...
    if (!isEdit) {
      ...
      // Только открываем ConfirmationModal
      setEditFormData(formData); // Сохраняем данные для последующего редактирования
      setIsConfirm(true); // Показываем ConfirmationModal
    }
  };
